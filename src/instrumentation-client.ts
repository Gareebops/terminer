...
// SAMO produkcija: DSN stoji i u lokalnom .env.local pa bi dev sesije slale
// šum u isti projekat (npr. "Failed to fetch" kad se dev server ugasi ispod
// otvorenog taba) i trošile besplatnu kvotu.
